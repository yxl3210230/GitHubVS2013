...
Net* DisjointM::INIT_readNetwork(string fileName_net,bool isUseLargestComp,bool isSymmetrize, int weight_version) {
	...
	net->readNetwork_EdgesList(fileName_net,isUseLargestComp,isSymmetrize, weight_version);
...
double DisjointM::calQ_unw(string fileName_cpm,string fileName_net,Net* net,bool isUseLargestComp,bool isSymmetrize, int weight_version){
	...
	if(!fileName_net.empty())
		net=INIT_readNetwork(fileName_net, isUseLargestComp, isSymmetrize, weight_version);
...
double DisjointM::calQ_unw_givenCpm(vector<vector<int> >& cpm,string fileName_net,Net* net,bool isUseLargestComp,bool isSymmetrize, int weight_version){
	//provide the network file or the net object(fileName_net="")
