...
public:
	...
	Net* INIT_readNetwork(string fileName_net,bool isUseLargestComp,bool isSymmetrize, int weight_version);
	...
	double calQ_unw(string fileName_cpm,string fileName_net,Net* net,bool isUseLargestComp,bool isSymmetrize, int weight_version);
	double calNMI(string fileName_cpmT,string fileName_cpmF);
	double calARI(string fileName_cpmT,string fileName_cpmF);


	//the cpm is given
	double calQ_unw_givenCpm(vector<vector<int> >& cpm,string fileName_net,Net* net,bool isUseLargestComp,bool isSymmetrize, int weight_version);
};
